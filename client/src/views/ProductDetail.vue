        ...
        <div class="col-md-7">
          <div class="card shadow-sm">
            <div class="card-body">
              ...
              <h5 class="card-title pt-3 pd-3 border-top">{{getCurrencyFormat(productDetail.product_price)}}</h5>
              ...
              <p class="card-text pb-3">
                배송비 {{getCurrencyFormat(productDetail.delivery_price)}}원 | 도서산간(제주도) 배송비 추가 {{getCurrencyFormat(productDetail.add_delivery_price)}}원 | 택배배송 | {{productDetail.outbound_days}}일 이내 출고 (추말,공휴일 제외)
              </p>
                ...
                <div class="row">
                  ...
                  <div class="col-auto">
                    <div class="input-group">
                      <span class="input-group-text" style="cursor:pointer;" @click="calaulatePrice(-1)">-</span>
